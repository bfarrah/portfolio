...
|------------------------------------------|---------------------------------------------------------------------------------|
|Parents/guardians have a wide variety of baseline knowledge about vaping.|I should change my introduction to cover basic information about vaping, including how common it is. This could be articulated by stating the average number of students per grade that use vapes, perhaps.|
